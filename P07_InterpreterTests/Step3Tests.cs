...
public class Step3Tests
{
    ...
    public void Test_SelectByColor()
    {
        ...
        List<Product> products = productRepo.SelectBySpecs(colorSpec);
    ...
    public void Test_SelectBySize()
    {
        ...
        List<Product> products = productRepo.SelectBySpecs(sizeSpec);
    ...
    public void TestSelectByBelowPrice() {
        ...
        List<Product> products = productRepo.SelectBySpecs(belowPriceSpec);
    ...
    public void TestSelectByColorSizeAndBelowPrice() {
        ...
        AndSpec colorAndSizeSpec = new AndSpec(colorSpec, sizeSpec);
        
        BelowPriceSpec belowPriceSpec = new BelowPriceSpec((decimal)10.0);
        AndSpec belowPriceAndColorAndSizeSpec = new AndSpec(belowPriceSpec, colorAndSizeSpec);
        
        List<Product> products = productRepo.SelectBySpecs(belowPriceAndColorAndSizeSpec);
    ...
    [Test]
    public void TestSelectByColorSizeOrNotBelowPrice() {
        ProductRepository productRepo = new ProductRepository(GenerateProducts());
        ...
        BelowPriceSpec belowPriceSpec = new BelowPriceSpec((decimal)200.0);
        NotSpec notBelowSpec = new NotSpec(belowPriceSpec);

        OrSpec notBelowOrColorAndSizeSpec = new OrSpec(notBelowSpec, colorAndSizeSpec);

        List<Product> products = productRepo.SelectBySpecs(notBelowOrColorAndSizeSpec);
