...
public class Step1Tests
{
    ...
    public void TestSelectByBelowPrice() {
        ...
        List<Product> products = productRepo.SelectByBelowPrice((decimal)10.0);
    ...
    public void TestSelectByColorSizeAndBelowPrice() {
        ...
        List<Product> products = productRepo.SelectByColorSizeAndBelowPrice(
            "red","small",(decimal)10.0);
